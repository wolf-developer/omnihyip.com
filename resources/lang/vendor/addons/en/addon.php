...
return [
    ...
    */
    ...
    'options'       => [
            ...
            'show_admin_menu' =>[0 =>'No', 1=>'Yes'],
            'manual_blockchain' =>[0 =>'No', 1=>'Yes'],
            'blockmove' =>[0 =>'No', 1=>'Yes'],
    ],
    ...
    'label'         => [
        ...
        'show_admin_menu'        => 'Show Admin Menu',
        'manual_blockchain'        => 'Manual Blockchain',
        'blockmove'            => 'Blockmove',
    ],
    ...
    'cloumns'         => [
        ...
        'blockmove'        => ['name' => 'Blockmove', 'data-column' => 5, 'checked'],
    ],
