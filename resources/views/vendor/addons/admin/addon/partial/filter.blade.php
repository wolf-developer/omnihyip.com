<div class="btn-group addons-addon">
...
<div class="container-fluid">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[admin_user_login]" class="col-sm-2 control-label">
                                        {!! trans('addons::addon.label.admin_user_login')!!}
                                    </label>
                                    <div class="col-sm-10">
                                        {!! Form::text('search[admin_user_login]')->raw()!!}
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[add_bank]" class="col-sm-2 control-label">
                                        {!! trans('addons::addon.label.add_bank')!!}
                                    </label>
                                    <div class="col-sm-10">
                                        {!! Form::text('search[add_bank]')->raw()!!}
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[hide_compound_rate]" class="col-sm-2 control-label">
                                        {!! trans('addons::addon.label.hide_compound_rate')!!}
                                    </label>
                                    <div class="col-sm-10">
                                        {!! Form::text('search[hide_compound_rate]')->raw()!!}
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[provide_google_authentication]" class="col-sm-2 control-label">
                                        {!! trans('addons::addon.label.provide_google_authentication')!!}
                                    </label>
                                    <div class="col-sm-10">
                                        {!! Form::text('search[provide_google_authentication]')->raw()!!}
                                    </div>
                                </div>
                            </div>
                            </div>
...
$(document).ready(function(){
    ...
    $(".addons-addon .btn-open").click(function(){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        $('#open-list').load("{!!guard_url('/settings/setting/search/addons.addon.search')!!}");
        $('#modal-open').modal("show");
    });

   $(".addons-addon .btn-search").click(function(){
      $('#modal-search').modal("show");
    });
   
    $('.addons-addon .btn-save').click(function(e){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        ...
        formData.append('key', 'addons.addon.search');
    ...
    $('#btn-apply-search').click( function() {
        ...
        oTable.api().draw();
        $('#addons-addon-list .btn-reset-filter').css('display', '');
    ...
    $(".btn-reset-filter").click(function (e) {
        ...
        oTable.api().draw();
        $('#addons-addon-list .btn-reset-filter').css('display', 'none');
