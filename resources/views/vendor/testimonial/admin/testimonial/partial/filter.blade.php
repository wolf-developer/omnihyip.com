...
<div class="container-fluid">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[client_name]" class="col-sm-4 control-label">
                                        {!! trans('testimonial::testimonial.label.client_name')!!}
                                    </label>
                                    <div class="col-sm-8">
                                        {!! Form::text('search[client_name]')->raw()!!}
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[status]" class="col-sm-4 control-label">
