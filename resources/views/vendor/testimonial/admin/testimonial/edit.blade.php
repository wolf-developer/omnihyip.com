    <div class="nav-tabs-custom">
        ...
        <ul class="nav nav-tabs primary">
            ...
            <div class="box-tools pull-right">
                <button type="button" class="btn btn-warning btn-sm" data-action='UPDATE' data-form='#testimonial-testimonial-edit'  data-load-to='#testimonial-testimonial-entry' data-datatable='#testimonial-testimonial-list'><i class="fa fa-floppy-o"></i> {{ trans('app.save') }}</button>
        ...
        <div class="tab-content clearfix">
            <div class="tab-pane active" id="testimonial">
                <div class="tab-pan-title">  {{ trans('app.edit') }}  {!! trans('testimonial::testimonial.name') !!}  </div>
