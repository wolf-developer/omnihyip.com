<div class="btn-group email_template-email_template">
...
<div class="container-fluid">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[subject]" class="col-sm-2 control-label">
                                        {!! trans('email_template::email_template.label.subject')!!}
                                    </label>
                                    <div class="col-sm-10">
                                        {!! Form::text('search[subject]')->raw()!!}
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[body]" class="col-sm-2 control-label">
                                        {!! trans('email_template::email_template.label.body')!!}
                                    </label>
                                    <div class="col-sm-10">
                                        {!! Form::text('search[body]')->raw()!!}
                                    </div>
                                </div>
                            </div>
                            </div>
...
$(document).ready(function(){
    ...
    $(".email_template-email_template .btn-open").click(function(){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        $('#open-list').load("{!!guard_url('/settings/setting/search/email_template.email_template.search')!!}");
        $('#modal-open').modal("show");
    });

   $(".email_template-email_template .btn-search").click(function(){
      $('#modal-search').modal("show");
    });
   
    $('.email_template-email_template .btn-save').click(function(e){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        ...
        formData.append('key', 'email_template.email_template.search');
    ...
    $('#btn-apply-search').click( function() {
        ...
        oTable.api().draw();
        $('#email_template-email_template-list .btn-reset-filter').css('display', '');
    ...
    $(".btn-reset-filter").click(function (e) {
        ...
        oTable.api().draw();
        $('#email_template-email_template-list .btn-reset-filter').css('display', 'none');
