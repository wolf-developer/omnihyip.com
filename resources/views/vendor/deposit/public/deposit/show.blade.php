            @include('plan::public.plan.partial.header')

            <section class="single">
                <div class="container">
                    <div class="row">
                        <div class="col-md-3">
                            @include('plan::public.plan.partial.aside')
                        </div>
                        <div class="col-md-9 ">
                            <div class="area">
                                <div class="item">
                                    <div class="feature">
                                        <img class="img-responsive center-block" src="{!!url($plan->defaultImage('images' , 'xl'))!!}" alt="{{$plan->title}}">
                                    </div>
                                    <div class="content">
                                        <div class="row">
        ...
        <div class="col-md-4 col-sm-6">
            <div class"form-group">
                <label for="interest_after_matured">
                    {!! trans('plan::plan.label.interest_after_matured') !!}
                </label><br />
                    {!! $plan['interest_after_matured'] !!}
            </div>
        </div>
        <div class="col-md-4 col-sm-6">
            <div class"form-group">
                <label for="release_deposit">
                    {!! trans('plan::plan.label.release_deposit') !!}
                </label><br />
                    {!! $plan['release_deposit'] !!}
            </div>
        </div>
        <div class="col-md-4 col-sm-6">
            <div class"form-group">
                <label for="profit">
                    {!! trans('plan::plan.label.profit') !!}
                </label><br />
                    {!! $plan['profit'] !!}
            </div>
        </div>
        <div class="col-md-4 col-sm-6">
            <div class"form-group">
                <label for="interest_period_type">
                    {!! trans('plan::plan.label.interest_period_type') !!}
                </label><br />
                    {!! $plan['interest_period_type'] !!}
            </div>
        </div>
        <div class="col-md-4 col-sm-6">
            <div class"form-group">
                <label for="investment_duration">
                    {!! trans('plan::plan.label.investment_duration') !!}
                </label><br />
                    {!! $plan['investment_duration'] !!}
            </div>
        </div>
        <div class="col-md-4 col-sm-6">
            <div class"form-group">
                <label for="investment_duration_type">
                    {!! trans('plan::plan.label.investment_duration_type') !!}
                </label><br />
                    {!! $plan['investment_duration_type'] !!}
            </div>
        </div>
    </div>
