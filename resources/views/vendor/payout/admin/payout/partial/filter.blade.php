<div class="btn-group payout-payout">
...
<div class="container-fluid">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[withdraw_minimum]" class="col-sm-2 control-label">
                                        {!! trans('payout::payout.label.withdraw_minimum')!!}
                                    </label>
                                    <div class="col-sm-10">
                                        {!! Form::text('search[withdraw_minimum]')->raw()!!}
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[withdraw_maximum]" class="col-sm-2 control-label">
                                        {!! trans('payout::payout.label.withdraw_maximum')!!}
                                    </label>
                                    <div class="col-sm-10">
                                        {!! Form::text('search[withdraw_maximum]')->raw()!!}
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[withdraw_allow_month]" class="col-sm-2 control-label">
                                        {!! trans('payout::payout.label.withdraw_allow_month')!!}
                                    </label>
                                    <div class="col-sm-10">
                                        {!! Form::text('search[withdraw_allow_month]')->raw()!!}
                                    </div>
                                </div>
                            </div>
                            </div>
...
$(document).ready(function(){
    ...
    $(".payout-payout .btn-open").click(function(){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        $('#open-list').load("{!!guard_url('/settings/setting/search/payout.payout.search')!!}");
        $('#modal-open').modal("show");
    });

   $(".payout-payout .btn-search").click(function(){
      $('#modal-search').modal("show");
    });
   
    $('.payout-payout .btn-save').click(function(e){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        ...
        formData.append('key', 'payout.payout.search');
    ...
    $('#btn-apply-search').click( function() {
        ...
        oTable.api().draw();
        $('#payout-payout-list .btn-reset-filter').css('display', '');
    ...
    $(".btn-reset-filter").click(function (e) {
        ...
        oTable.api().draw();
        $('#payout-payout-list .btn-reset-filter').css('display', 'none');
