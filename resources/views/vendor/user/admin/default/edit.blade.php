    <div class="nav-tabs-custom">
        ...
        <ul class="nav nav-tabs primary">
            ...
            <div class="box-tools pull-right">
                <button id="clientEdit" type="button" class="btn btn-warning btn-sm" data-action='UPDATE' data-form='#user-client-edit'  data-load-to='#user-client-entry' data-datatable='#user-client-list'><i class="fa fa-floppy-o"></i> {{ trans('app.save') }}</button>
