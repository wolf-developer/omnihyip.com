<div class="btn-group affiliate-affiliate">
...
<div class="container-fluid">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[ref_level_1]" class="col-sm-2 control-label">
                                        {!! trans('affiliate::affiliate.label.ref_level_1')!!}
                                    </label>
                                    <div class="col-sm-10">
                                        {!! Form::text('search[ref_level_1]')->raw()!!}
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[ref_level_2]" class="col-sm-2 control-label">
                                        {!! trans('affiliate::affiliate.label.ref_level_2')!!}
                                    </label>
                                    <div class="col-sm-10">
                                        {!! Form::text('search[ref_level_2]')->raw()!!}
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[ref_level_3]" class="col-sm-2 control-label">
                                        {!! trans('affiliate::affiliate.label.ref_level_3')!!}
                                    </label>
                                    <div class="col-sm-10">
                                        {!! Form::text('search[ref_level_3]')->raw()!!}
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[ref_level_4]" class="col-sm-2 control-label">
                                        {!! trans('affiliate::affiliate.label.ref_level_4')!!}
                                    </label>
                                    <div class="col-sm-10">
                                        {!! Form::text('search[ref_level_4]')->raw()!!}
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[ref_level_5]" class="col-sm-2 control-label">
                                        {!! trans('affiliate::affiliate.label.ref_level_5')!!}
                                    </label>
                                    <div class="col-sm-10">
                                        {!! Form::text('search[ref_level_5]')->raw()!!}
                                    </div>
                                </div>
                            </div>
                            </div>
...
$(document).ready(function(){
    ...
    $(".affiliate-affiliate .btn-open").click(function(){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        $('#open-list').load("{!!guard_url('/settings/setting/search/affiliate.affiliate.search')!!}");
        $('#modal-open').modal("show");
    });

   $(".affiliate-affiliate .btn-search").click(function(){
      $('#modal-search').modal("show");
    });
   
    $('.affiliate-affiliate .btn-save').click(function(e){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        ...
        formData.append('key', 'affiliate.affiliate.search');
    ...
    $('#btn-apply-search').click( function() {
        ...
        oTable.api().draw();
        $('#affiliate-affiliate-list .btn-reset-filter').css('display', '');
    ...
    $(".btn-reset-filter").click(function (e) {
        ...
        oTable.api().draw();
        $('#affiliate-affiliate-list .btn-reset-filter').css('display', 'none');
