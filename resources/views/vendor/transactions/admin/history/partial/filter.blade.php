<div class="btn-group transactions-history">
...
<div class="container-fluid">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[user_id]" class="col-sm-4 control-label">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[transaction_type]" class="col-sm-4 control-label">
                                        {!! trans('transactions::history.label.transaction_type')!!}
                                    </label>
                                    <div class="col-sm-8">
                                        {!! Form::select('search[transaction_type]')
                    ...
                    -> placeholder(trans('transactions::history.placeholder.transaction_type'))!!}
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[payment_thro]" class="col-sm-4 control-label">
                                        {!! trans('transactions::history.label.payment_thro')!!}
                                    </label>
                                    <div class="col-sm-8">
                                        {!! Form::text('search[payment_thro]')->raw()!!}
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[transaction_id]" class="col-sm-4 control-label">
                ...
                <div class="modal-footer">
                    <div class="col-md-12 col-lg-12">
                        <button aria-label="Close" class="btn pull-right btn-warning" data-dismiss="modal" type="button">
                            <i class="fa fa-times-circle">
                            </i>
                            Close
                        </button>
                        <button class="btn btn-default pull-right " id="btn-apply-search" name="new" style="margin-right:1%" type="button">
...
$(document).ready(function(){
    ...
    $(".transactions-history .btn-open").click(function(){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        $('#open-list').load("{!!guard_url('/settings/setting/search/transactions.history.search')!!}");
        $('#modal-open').modal("show");
    });

   $(".transactions-history .btn-search").click(function(){
      $('#modal-search').modal("show");
    });
   
    $('.transactions-history .btn-save').click(function(e){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        ...
        formData.append('key', 'transactions.history.search');
    ...
    $('#btn-apply-search').click( function() {
        ...
        oTable.api().draw();
        $('#transactions-history-list .btn-reset-filter').css('display', '');
    ...
    $(".btn-reset-filter").click(function (e) {
        ...
        oTable.api().draw();
        $('#transactions-history-list .btn-reset-filter').css('display', 'none');
