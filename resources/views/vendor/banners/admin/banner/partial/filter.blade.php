<div class="btn-group banners-banner">
...
<div class="modal fade" id="modal-open">
  <div class="modal-dialog">
    <div class="modal-content" style="max-width:400px;">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-default"  name="Closerep" data-dismiss="modal"><i class="fa fa-times-circle"></i> Close </button>
      </div>
    </div><!-- /.modal-content -->
  </div><!-- /.modal-dialog -->
</div><!-- /.modal -->
...
$(document).ready(function(){
    ...
    $(".banners-banner .btn-open").click(function(){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        $('#open-list').load("{!!guard_url('/settings/setting/search/banners.banner.search')!!}");
        $('#modal-open').modal("show");
    });

   $(".banners-banner .btn-search").click(function(){
      $('#modal-search').modal("show");
    });
   
    $('.banners-banner .btn-save').click(function(e){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        ...
        formData.append('key', 'banners.banner.search');
    ...
    $('#btn-apply-search').click( function() {
        ...
        oTable.api().draw();
        $('#banners-banner-list .btn-reset-filter').css('display', '');
    ...
    $(".btn-reset-filter").click(function (e) {
        ...
        oTable.api().draw();
        $('#banners-banner-list .btn-reset-filter').css('display', 'none');
