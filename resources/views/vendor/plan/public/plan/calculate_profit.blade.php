...
<style type="text/css">form { margin-top: 0px;margin-bottom: 0px;margin-left: 0px;margin-right: 0px;}
.toptable {
...
percents[0] = new Array(<?php echo $min_amount;?>, <?php echo $max_amount;?>, <?php echo $interest;?>);

paymentperiod = '<?php echo $paymentperiod;?>'; // 'd' - daily, 'w' - weekly, 'bw' - beweekly, 'm' - monthly, 'y' - yearly
var maxdays = 365;
...
<tr>
  <td><?php echo $profit_dur?>:</td><td><b><span id="days">0</span></b></td>
</tr>
<tr>
  <td>Profit Type:</td><td><b><?php echo $profit_type?></b></td>
</tr>
</tr>
  <td>Amount:</td><td nowrap>$ <input type="text" name="amount" value="<?php echo $min_amount;?>" size=5 class=inpts> <input type="button" value="Calculate" onclick="CalculateProfit()" class=sbmt></td>
</tr>
<tr>
...
<tr>
  <td>Profit Interest:</td><td><b><span id="percent"><?php echo $interest;?></span></b></td>
</tr>
<tr>
  <td>Profit $:</td><td><b><span id="profit">0</span></b></td>
</tr>
<tr>
  <td nowrap>Deposit $:</td><td><b><span id="deposit">0</span></b></td>
</tr>
