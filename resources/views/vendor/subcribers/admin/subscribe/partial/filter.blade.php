<div class="btn-group subcribers-subscribe">
...
<div class="container-fluid">
                            <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        {!! Form::text('search[sub_email]')->raw()!!}
                                    </div>
                                </div>
                            </div>
                            </div>
...
$(document).ready(function(){
    ...
    $(".subcribers-subscribe .btn-open").click(function(){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        $('#open-list').load("{!!guard_url('/settings/setting/search/subcribers.subscribe.search')!!}");
        $('#modal-open').modal("show");
    });

   $(".subcribers-subscribe .btn-search").click(function(){
      $('#modal-search').modal("show");
    });
   
    $('.subcribers-subscribe .btn-save').click(function(e){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        ...
        formData.append('key', 'subcribers.subscribe.search');
    ...
    $('#btn-apply-search').click( function() {
        ...
        oTable.api().draw();
        $('#subcribers-subscribe-list .btn-reset-filter').css('display', '');
    ...
    $(".btn-reset-filter").click(function (e) {
        ...
        oTable.api().draw();
        $('#subcribers-subscribe-list .btn-reset-filter').css('display', 'none');
