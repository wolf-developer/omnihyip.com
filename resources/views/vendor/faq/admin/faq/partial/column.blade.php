<button class="btn btn-xs btn-default" id="manage-column" type="button">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body clearfix">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col3 manage-column">
                    ...
                    ->checkboxes(trans('faq::faq.cloumns'))
                    ->inline()
                    ->raw()!!}
            ...
            <div class="modal-footer">
                <button class="btn btnTheme" id="save_columns_settings" type="button">
                    <i class="fa fa-check-circle aria-hidden=" true""="">
                    </i>
                    Save
                </button>
                <button class="btn btn-warning" id="btn-reset-column" type="button">
...
<script type="text/javascript">
    ...
    $("#save_columns_settings").click(function(){
        ...
        formData.append('key', 'faq.faq.column');
        formData.append('package', 'Faq');
        formData.append('module', 'Faq');
