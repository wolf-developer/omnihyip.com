...
<div class="container-fluid">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[question]" class="col-sm-2 control-label">
                                        {!! trans('faq::faq.label.question')!!}
                                    </label>
                                    <div class="col-sm-10">
                                        {!! Form::text('search[question]')->raw()!!}
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        {!! Form::date('search[created_at]')->raw()!!}
                                    </div>
                                </div>
                            </div>
                            </div>
...
$(document).ready(function(){
    ...
    $(".faq-faq .btn-open").click(function(){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        $('#open-list').load("{!!guard_url('/settings/setting/search/faq.faq.search')!!}");
        $('#modal-open').modal("show");
    });

   $(".faq-faq .btn-search").click(function(){
      $('#modal-search').modal("show");
    });
   
    $('.faq-faq .btn-save').click(function(e){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        ...
        formData.append('key', 'faq.faq.search');
    ...
    $('#btn-apply-search').click( function() {
        ...
        oTable.api().draw();
        $('#faq-faq-list .btn-reset-filter').css('display', '');
    ...
    $(".btn-reset-filter").click(function (e) {
        ...
        oTable.api().draw();
        $('#faq-faq-list .btn-reset-filter').css('display', 'none');
