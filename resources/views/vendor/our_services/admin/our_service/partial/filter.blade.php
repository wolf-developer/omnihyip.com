<div class="btn-group our_services-our_service">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[title]" class="col-sm-2 control-label">
                                        {!! trans('our_services::our_service.label.title')!!}
                                    </label>
                                    <div class="col-sm-10">
...
$(document).ready(function(){
    ...
    $(".our_services-our_service .btn-open").click(function(){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        $('#open-list').load("{!!guard_url('/settings/setting/search/our_services.our_service.search')!!}");
        $('#modal-open').modal("show");
    });

   $(".our_services-our_service .btn-search").click(function(){
      $('#modal-search').modal("show");
    });
   
    $('.our_services-our_service .btn-save').click(function(e){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        ...
        formData.append('key', 'our_services.our_service.search');
    ...
    $('#btn-apply-search').click( function() {
        ...
        oTable.api().draw();
        $('#our_services-our_service-list .btn-reset-filter').css('display', '');
    ...
    $(".btn-reset-filter").click(function (e) {
        ...
        oTable.api().draw();
        $('#our_services-our_service-list .btn-reset-filter').css('display', 'none');
