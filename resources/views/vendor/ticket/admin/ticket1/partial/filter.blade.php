...
<div class="container-fluid">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[ticket_code]" class="col-sm-2 control-label">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[ticket_subject]" class="col-sm-2 control-label">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[ticket_body]" class="col-sm-2 control-label">
                                        {!! trans('ticket::ticket.label.ticket_body')!!}
                                    </label>
                                    <div class="col-sm-10">
                                        {!! Form::text('search[ticket_body]')->raw()!!}
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[ticket_status]" class="col-sm-2 control-label">
                                        {!! trans('ticket::ticket.label.ticket_status')!!}
                                    </label>
                                    <div class="col-sm-10">
                                        {!! Form::text('search[ticket_status]')->raw()!!}
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[ticket_user]" class="col-sm-2 control-label">
                                        {!! trans('ticket::ticket.label.ticket_user')!!}
                                    </label>
                                    <div class="col-sm-10">
                                        {!! Form::text('search[ticket_user]')->raw()!!}
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[ticket_priority]" class="col-sm-2 control-label">
                                        {!! trans('ticket::ticket.label.ticket_priority')!!}
                                    </label>
                                    <div class="col-sm-10">
                                        {!! Form::text('search[ticket_priority]')->raw()!!}
                                    </div>
                                </div>
                            </div>
                            </div>
