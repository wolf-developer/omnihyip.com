<div class="btn-group ticket-ticket_reply">
...
<div class="container-fluid">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[ticket_id]" class="col-sm-2 control-label">
                                        {!! trans('ticket::ticket_reply.label.ticket_id')!!}
                                    </label>
                                    <div class="col-sm-10">
                                        {!! Form::text('search[ticket_id]')->raw()!!}
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[replier_id]" class="col-sm-2 control-label">
                                        {!! trans('ticket::ticket_reply.label.replier_id')!!}
                                    </label>
                                    <div class="col-sm-10">
                                        {!! Form::text('search[replier_id]')->raw()!!}
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[attachment]" class="col-sm-2 control-label">
                                        {!! trans('ticket::ticket_reply.label.attachment')!!}
                                    </label>
                                    <div class="col-sm-10">
                                        {!! Form::text('search[attachment]')->raw()!!}
                                    </div>
                                </div>
                            </div>
                            </div>
...
$(document).ready(function(){
    ...
    $(".ticket-ticket_reply .btn-open").click(function(){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        $('#open-list').load("{!!guard_url('/settings/setting/search/ticket.ticket_reply.search')!!}");
        $('#modal-open').modal("show");
    });

   $(".ticket-ticket_reply .btn-search").click(function(){
      $('#modal-search').modal("show");
    });
   
    $('.ticket-ticket_reply .btn-save').click(function(e){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        ...
        formData.append('key', 'ticket.ticket_reply.search');
    ...
    $('#btn-apply-search').click( function() {
        ...
        oTable.api().draw();
        $('#ticket-ticket_reply-list .btn-reset-filter').css('display', '');
    ...
    $(".btn-reset-filter").click(function (e) {
        ...
        oTable.api().draw();
        $('#ticket-ticket_reply-list .btn-reset-filter').css('display', 'none');
