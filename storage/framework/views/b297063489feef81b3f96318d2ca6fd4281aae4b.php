...
<div class="prodbg4">
   <canvas id="canvas2" width="1366" height="235"></canvas>
</div>
            ...
            <div class="col-lg-4 col-lg-offset-4 col-md-8 col-md-offset-2 col-sm-8 col-sm-offset-2 col-xs-12">
               ...
               <div class="logIn">
                  <div class="login-logo2">
                     <figure class="logiimg"> <a href="<?php echo guard_url('/'); ?>"><img src="<?php echo getCompanyLogo(); ?>" class="img-responsive center-block" alt="<?php echo e(getCompanyinfo('company_name')); ?>" title="<?php echo e(getCompanyinfo('company_name')); ?>" style="max-height:60px;"></a>
                     </figure>
                  </div>
               </div>
                  ...
                  <div class="col-lg-12  col-md-12 col-sm-12">
                     <div class="login-form">
                        <div class="login-body">
                           ...
                           <h2 class="fa22">Enter 2FA Code, You have received</h2>
                           <?php
                        ...
                        <?php
                           ...
                           ?>
                        <?php endif; ?>      
                        <div class="form-group <?php echo e($hidden); ?>">
                           <?php echo Form::text('email')->placeholder('Enter your email')->class('form-control')->raw(); ?>

                        </div>
                        <div class="form-group <?php echo e($hidden); ?>">
                           <input class="form-control" placeholder="Password" required="" id="password" type="password" name="password" value="<?php echo e($password); ?>">
                        </div>
                        <?php if((getCompanyinfo('captcha_admin_login')==1)): ?>
                        ...
                        <input type="submit" name="Sign In" class="btn logibtn" value="Sign In">
                        <?php echo Form::Close(); ?>
      ...
      submitHandler: function(form) {
            ...
            $(function() {
             ...
             var bubbles = [], // Holds all the bubbles as objects
                 ...
                 minSpeed = 5,
                 maxSpeed = 10,
                 bgcolor = 'hsl(200, 60%, 35%)', // Canvas bg
