 ...
 <?php if($menu->status == 1) { ?>
    ...
    <li class="treeview <?php echo e(isset($menu->active) ? $menu->active : ''); ?>">
        <a href="<?php echo e(trans_url($menu->url)); ?>" >
            <i class="<?php echo e(isset($menu->icon) ? $menu->icon : 'fa fa-angle-double-right'); ?>"></i> <span><?php echo e($menu->name); ?></span>
    ...
    <?php else: ?>
    <li  <?php echo e(isset($menu->active) ? $menu->active : ''); ?>>
        <a href="<?php echo e(trans_url($menu->url)); ?>">
            <i class="<?php echo e(isset($menu->icon) ? $menu->icon : 'fa fa-angle-double-right'); ?>"></i>
